Распределительный контест
#########################

:date: 2019-09-02 09:00
:summary: Распределительный контест
:status: published

.. default-role:: code
.. contents:: Содержание

Распределительный контест для ФЭФМ
==================================

Данный контест необходим для распределения по базовым и продвинутым группам. По ссылке ниже вы перейдете на страницу регистрации на контест.
При регистрации пожалуйста создайте логин в следующем формате: 0400X_Y_Z, где X - последняя цифра вашей группы, Y - фамилия на латинице, Z - инициалы на латинице.
Например, 04001_ivanov_ii. Данный формат логинов поможет преподавателям идентифицировать вас и фильтровать по группам. Постарайтесь не терять ваши логины и пароли к
ним, они понадобятся на протяжении этого учебного года.

`Ссылка на контест`_

.. _`Ссылка на контест`: http://judge2.vdi.mipt.ru/cgi-bin/new-register?contest_id=94200
...
.. _`Списки групп`: https://docs.google.com/spreadsheets/d/1grvZuKpvUa91GYmNSebkXRTrDhW0xaT4_OKO9osy75U/edit?usp=sharing
