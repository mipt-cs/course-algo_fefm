...
При регистрации пожалуйста создайте логин в следующем формате: 0410X_Y_Z, где X - последняя цифра вашей группы, Y - фамилия на латинице, Z - инициалы на латинице.
Например, 04101_ivanov_ii. Данный формат логинов поможет преподавателям идентифицировать вас и фильтровать по группам. Постарайтесь не терять ваши логины и пароли к
